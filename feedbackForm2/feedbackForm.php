...
<html lang="en" style="height:100%;">
    ...
    <section class="content-block content-1-8 bg-offwhite pad-bottom0">
        <!-- /.container -->
    </section>
        ...
        <div class="container footer-1-1 pad10">
            ...
            <div class="row text-center">
                <div class="col-sm-5 col-sm-offset-0 pull-left">
                    ...
                    <p class="lead">2700 West Oakland Park Boulevard, Suite 26</p>
                    <p class="lead">Oakland Park, FL 33311</p>
                </div>
                <div class="col-sm-5 col-sm-offset-1 pull-right">
                    <h3><strong>Mailing Address</strong></h3>
                    <p class="lead">PO Box 101617</p>
                    <p class="lead">Fort Lauderdale, FL 33310</p>
                </div>
            </div>
            <!-- /.row -->
        </div>
