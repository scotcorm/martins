...
<html lang="en" style="height:100%;">
    ...
    <header id="header-1" class="soft-scroll header-1 bg-sunflower margin-bottom20">
        <h2 class="text-center pad20"><i><b>Join our Email List</b></i></h2>
        <!-- Navbar -->
        <!--// End Navbar -->
    </header>
                ...
                <section id="content-2-9" class="content-2-9 bg-sunflower">
                    ...
                    <div class="row">
                        <div class="offset-md-3 form col-md-12 btn-secondary contact">
                            <h1 class="text-center"><i>Enter Your Information to Join Our Email List!</i></h1> 
                            <?php echo $result;?>
                            <p class="contactp">Enter your information, and don't forget to check the box to confirm that you are human!&nbsp;</p>
