                    ...
                    <div class="row">
                        <div class="offset-md-3 form col-md-12 btn-secondary contact">
                            ...
                            <form method="post" role="form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Your phone number" value="<?php echo $_POST['name']; ?>">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control" placeholder="Your email" value="<?php echo $_POST['email']; ?>">
                                </div>
                                <div class="form-group">
                                    <textarea name="message" rows="5" class="form-control" placeholder="Request a prayer..."><?php echo $_POST['message']; ?></textarea>
                                </div>
